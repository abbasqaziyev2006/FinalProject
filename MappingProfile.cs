...
namespace ECommerceCoza.BLL.Mapping
{
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            // ?? DÜZ?LDILMI? - Price v? SalePrice ?lav? edildi
            CreateMap<ProductVariant, ProductVariantViewModel>()
                ...
                // Use the variant's sale price if present, otherwise regular variant price.
                .ForMember(x => x.Priced, opt => opt.MapFrom(src => src.SalePrice ?? src.Price))
                .ReverseMap();
